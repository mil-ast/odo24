...
--
-- Name: updateavto(bigint, integer, character varying, bigint, boolean); Type: FUNCTION; Schema: cars; Owner: pavel
--
...
ALTER FUNCTION cars.updateavto(_avto_id bigint, _odo integer, _name character varying, _user_id bigint, _public boolean) OWNER TO pavel;
...
declare
	...
	_user_id int8;
begin
	select u.user_id from profiles.users u into _user_id where u.login=$1;
...
begin
	...
	select * into u
	from profiles.users user_row where user_row.login=_login;
...
begin
	...
	if exists(select 1 from profiles.users u where u.login=_login) then
...
18	Ipsum	179998	10	f	f
1	Nissan Teana	182500	1	t	f
\.
...
COPY profiles.users (user_id, login, password_hash, confirmed, last_login_dt) FROM stdin;
11	andreev.zapchast-lider@yandex.ru	\\x63c1ac5450b0e2604c262e4a96bb25dc68d1a2fa1c8fa92e537fdac7098ea1e9	f	2019-02-20 11:39:42.802285
0	admin	\\x3509c18dce81d24b7d3780748e7b80024b5d802023e58f030d905395b1d192a1	t	2222-11-22 22:22:22
10	mil-ast@ya.ru	\\xa320480f534776bddb5cdb54b1e93d210a3c7d199e80a23c1b2178497b184c76	t	2019-02-24 16:45:11.914223
12	info@odo24.ru	\\xa320480f534776bddb5cdb54b1e93d210a3c7d199e80a23c1b2178497b184c76	t	2019-02-24 16:55:44.658068
1	mil-ast@yandex.ru	\\xa320480f534776bddb5cdb54b1e93d210a3c7d199e80a23c1b2178497b184c76	t	2019-02-26 17:27:09.169811
\.
...
17	1	insurance	2018-05-05	2019-02-26	30	Альфастрахование	f	1
\.
...
SELECT pg_catalog.setval('cars.avto_avto_id_seq', 18, true);
...
SELECT pg_catalog.setval('cars.services_service_id_seq', 37, true);
...
SELECT pg_catalog.setval('profiles.users_user_id_seq', 12, true);
...
SELECT pg_catalog.setval('reminding.reminding_id_seq', 17, true);
